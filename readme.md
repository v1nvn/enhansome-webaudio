...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 449,689 | 🐛 88 | 📅 2026-03-09
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 449,689 | 🐛 88 | 📅 2026-03-09 list thing.
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,739 | 🐛 63 | 🌐 TypeScript | 📅 2026-03-29 - A framework for making interactive music in the browser.
* [Omnitone](https://github.com/GoogleChrome/omnitone) ⭐ 905 | 🐛 30 | 🌐 JavaScript | 📅 2026-03-20 - Ambisonic spatial audio on the web.
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 729 | 🐛 24 | 🌐 C++ | 📅 2026-03-28 - Web Audio API implementation for native apps based on react-native.
...
* [Howler.js](https://github.com/goldfire/howler.js) ⭐ 25,231 | 🐛 415 | 🌐 JavaScript | 📅 2025-11-23 - A comprehensive library with a fallback to HTML5 Audio.
* [Wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,163 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-25 - Interactive navigable audio visualization using Web Audio and Canvas.
* [@magenta/music](https://github.com/magenta/magenta-js/tree/master/music) ⭐ 2,113 | 🐛 130 | 🌐 TypeScript | 📅 2026-03-28 - A JavaScript library to use machine learning models and generate music in the browser, by having some neat abstractions over the Webaudio API.
...
* [virtual-audio-graph](https://github.com/benji6/virtual-audio-graph) ⭐ 364 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-28 - Library for declaratively manipulating the Web Audio API.
...
* [Audiojs](https://github.com/audiojs/audio) ⭐ 237 | 🐛 28 | 🌐 JavaScript | 📅 2026-03-28 - An object that enables you to store, read, and write PCM audio data more easily.
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,622 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-28 - Multitrack Web Audio editor and player with canvas waveform preview. Set cues, fades and shift multiple tracks in time. Record audio tracks or provide audio annotations. Export your mix to AudioBuffer or WAV! Project inspired by Audacity.
