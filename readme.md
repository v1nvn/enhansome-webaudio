...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 450,944 | 🐛 65 | 📅 2026-04-01
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 450,944 | 🐛 65 | 📅 2026-04-01 list thing.
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,729 | 🐛 63 | 🌐 TypeScript | 📅 2026-03-29 - A framework for making interactive music in the browser.
* [Omnitone](https://github.com/GoogleChrome/omnitone) ⭐ 906 | 🐛 30 | 🌐 JavaScript | 📅 2026-03-20 - Ambisonic spatial audio on the web.
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 732 | 🐛 25 | 🌐 C++ | 📅 2026-04-01 - Web Audio API implementation for native apps based on react-native.
...
* [Wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,174 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-25 - Interactive navigable audio visualization using Web Audio and Canvas.
...
* [html-midi-player](https://github.com/cifkao/html-midi-player) ⭐ 864 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - HTML elements for easy MIDI playback and visualization, without the need to write any custom JS code, but scriptable and stylable as needed.
* [virtual-audio-graph](https://github.com/benji6/virtual-audio-graph) ⭐ 364 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-01 - Library for declaratively manipulating the Web Audio API.
...
* [Audiojs](https://github.com/audiojs/audio) ⭐ 237 | 🐛 28 | 🌐 JavaScript | 📅 2026-04-01 - An object that enables you to store, read, and write PCM audio data more easily.
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,621 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-01 - Multitrack Web Audio editor and player with canvas waveform preview. Set cues, fades and shift multiple tracks in time. Record audio tracks or provide audio annotations. Export your mix to AudioBuffer or WAV! Project inspired by Audacity.
