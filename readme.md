...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 454,669 | 🐛 62 | 📅 2026-04-02
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 454,669 | 🐛 62 | 📅 2026-04-02 list thing.
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,640 | 🐛 65 | 🌐 TypeScript | 📅 2026-04-10 - A framework for making interactive music in the browser.
* [Omnitone](https://github.com/GoogleChrome/omnitone) ⭐ 908 | 🐛 30 | 🌐 JavaScript | 📅 2026-04-09 - Ambisonic spatial audio on the web.
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 737 | 🐛 24 | 🌐 C++ | 📅 2026-04-12 - Web Audio API implementation for native apps based on react-native.
...
* [Howler.js](https://github.com/goldfire/howler.js) ⭐ 25,243 | 🐛 415 | 🌐 JavaScript | 📅 2025-11-23 - A comprehensive library with a fallback to HTML5 Audio.
* [Wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,184 | 🐛 46 | 🌐 TypeScript | 📅 2026-04-12 - Interactive navigable audio visualization using Web Audio and Canvas.
...
* [Audiojs](https://github.com/audiojs/audio) ⭐ 237 | 🐛 12 | 🌐 JavaScript | 📅 2026-04-12 - An object that enables you to store, read, and write PCM audio data more easily.
