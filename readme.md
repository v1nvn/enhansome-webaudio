...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 449,442 | 🐛 88 | 📅 2026-03-09
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 449,442 | 🐛 88 | 📅 2026-03-09 list thing.

Please raise a [Pull-Request](https://github.com/notthetup/awesome-webaudio/pulls) ⭐ 1,333 | 🐛 2 | 📅 2026-03-21 to add an awesome WebAudio thing to this list.
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,738 | 🐛 62 | 🌐 TypeScript | 📅 2026-03-25 - A framework for making interactive music in the browser.
* [Omnitone](https://github.com/GoogleChrome/omnitone) ⭐ 905 | 🐛 30 | 🌐 JavaScript | 📅 2026-03-20 - Ambisonic spatial audio on the web.
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 729 | 🐛 23 | 🌐 C++ | 📅 2026-03-27 - Web Audio API implementation for native apps based on react-native.
...
* [Mach1Spatial](https://github.com/Mach1Studios/m1-sdk) ⭐ 65 | 🐛 2 | 🌐 C | 📅 2026-03-06 - Vector based panning spatial audio on the web.
...
* [Howler.js](https://github.com/goldfire/howler.js) ⭐ 25,232 | 🐛 415 | 🌐 JavaScript | 📅 2025-11-23 - A comprehensive library with a fallback to HTML5 Audio.
* [Wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,161 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-25 - Interactive navigable audio visualization using Web Audio and Canvas.
* [@magenta/music](https://github.com/magenta/magenta-js/tree/master/music) ⭐ 2,113 | 🐛 129 | 🌐 TypeScript | 📅 2026-03-27 - A JavaScript library to use machine learning models and generate music in the browser, by having some neat abstractions over the Webaudio API.
...
* [Tuna](https://github.com/Theodeus/tuna) ⭐ 1,815 | 🐛 3 | 🌐 JavaScript | 📅 2026-03-26 - An audio effects library.
...
* [html-midi-player](https://github.com/cifkao/html-midi-player) ⭐ 862 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - HTML elements for easy MIDI playback and visualization, without the need to write any custom JS code, but scriptable and stylable as needed.
* [virtual-audio-graph](https://github.com/benji6/virtual-audio-graph) ⭐ 364 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-27 - Library for declaratively manipulating the Web Audio API.
...
* [Audiojs](https://github.com/audiojs/audio) ⭐ 237 | 🐛 28 | 🌐 JavaScript | 📅 2026-03-27 - An object that enables you to store, read, and write PCM audio data more easily.
...
* [MusicXML Player](https://github.com/infojunkie/musicxml-player) ⭐ 75 | 🐛 12 | 🌐 TypeScript | 📅 2026-03-27 - A TypeScript component that loads and plays MusicXML files in the browser using Web Audio and Web MIDI.
...
* [Audion](https://github.com/google/audion) ⭐ 388 | 🐛 23 | 🌐 TypeScript | 📅 2026-03-25 - Chrome extension that adds a Web Audio panel to Developer Tools.
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,621 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-27 - Multitrack Web Audio editor and player with canvas waveform preview. Set cues, fades and shift multiple tracks in time. Record audio tracks or provide audio annotations. Export your mix to AudioBuffer or WAV! Project inspired by Audacity.
