...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 449,198 | 🐛 89 | 📅 2026-03-09
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 449,198 | 🐛 89 | 📅 2026-03-09 list thing.
...
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 729 | 🐛 21 | 🌐 C++ | 📅 2026-03-26 - Web Audio API implementation for native apps based on react-native.
...
* [Howler.js](https://github.com/goldfire/howler.js) ⭐ 25,230 | 🐛 415 | 🌐 JavaScript | 📅 2025-11-23 - A comprehensive library with a fallback to HTML5 Audio.
* [Wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,159 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-25 - Interactive navigable audio visualization using Web Audio and Canvas.
...
* [html-midi-player](https://github.com/cifkao/html-midi-player) ⭐ 863 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - HTML elements for easy MIDI playback and visualization, without the need to write any custom JS code, but scriptable and stylable as needed.
* [virtual-audio-graph](https://github.com/benji6/virtual-audio-graph) ⭐ 364 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-26 - Library for declaratively manipulating the Web Audio API.
...
* [MusicXML Player](https://github.com/infojunkie/musicxml-player) ⭐ 75 | 🐛 12 | 🌐 TypeScript | 📅 2026-03-12 - A TypeScript component that loads and plays MusicXML files in the browser using Web Audio and Web MIDI.
...
* [waveform-playlist](https://github.com/naomiaro/waveform-playlist) ⭐ 1,621 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-27 - Multitrack Web Audio editor and player with canvas waveform preview. Set cues, fades and shift multiple tracks in time. Record audio tracks or provide audio annotations. Export your mix to AudioBuffer or WAV! Project inspired by Audacity.
