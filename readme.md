...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 452,996 | 🐛 61 | 📅 2026-04-02
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 452,996 | 🐛 61 | 📅 2026-04-02 list thing.
...
* [Tone.js](https://github.com/Tonejs/Tone.js) ⭐ 14,730 | 🐛 63 | 🌐 TypeScript | 📅 2026-03-29 - A framework for making interactive music in the browser.
* [Omnitone](https://github.com/GoogleChrome/omnitone) ⭐ 908 | 🐛 30 | 🌐 JavaScript | 📅 2026-03-20 - Ambisonic spatial audio on the web.
* [React Native Audio API](https://github.com/software-mansion-labs/react-native-audio-api) ⭐ 735 | 🐛 26 | 🌐 C++ | 📅 2026-04-07 - Web Audio API implementation for native apps based on react-native.
...
* [Howler.js](https://github.com/goldfire/howler.js) ⭐ 25,239 | 🐛 415 | 🌐 JavaScript | 📅 2025-11-23 - A comprehensive library with a fallback to HTML5 Audio.
* [Wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,178 | 🐛 46 | 🌐 TypeScript | 📅 2026-04-05 - Interactive navigable audio visualization using Web Audio and Canvas.
* [@magenta/music](https://github.com/magenta/magenta-js/tree/master/music) ⭐ 2,116 | 🐛 131 | 🌐 TypeScript | 📅 2026-04-02 - A JavaScript library to use machine learning models and generate music in the browser, by having some neat abstractions over the Webaudio API.
...
* [html-midi-player](https://github.com/cifkao/html-midi-player) ⭐ 865 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - HTML elements for easy MIDI playback and visualization, without the need to write any custom JS code, but scriptable and stylable as needed.
...
* [Audiojs](https://github.com/audiojs/audio) ⭐ 237 | 🐛 28 | 🌐 JavaScript | 📅 2026-04-08 - An object that enables you to store, read, and write PCM audio data more easily.
...
* [javascript-karplus-strong](https://github.com/mrahtz/javascript-karplus-strong) ⭐ 301 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-20 - JavaScript/Web Audio implementation of Karplus-Strong guitar synthesis.
